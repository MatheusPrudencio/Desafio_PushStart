...
it('teste', () => {
    ...
    preencheMatriz.objetos.forEach(element => {
        preencheMatriz.criaObjsApartirDasIntersecoes(element)
    });


    console.log( preencheMatriz)

    preencheMatriz.calculaAreaDosObjs()
    try{
        controller.addRandomNaMatriz()
    }catch(err){
        console.error(err)
    }
    controller.pMatriz.resetaObjsELinhas()
    ...
    console.log( preencheMatriz.matriz.matriz2D)
    preencheMatriz.calculaAreaDosObjs()
